...
LIMPAWINDOW
	...
	bcf		SPLASH				;Indica que ocorreu uma SplashWindow.
...
;########### APÓS EXECUTAR OS COMANDOS NÃO POSSO ESQUECER DE VOLTAR PRO SEM_SINC_H!!!!!
	...
	btfsc		SPLASH				;Teste se ocorreu uma SplashWindow.
	call		LIMPAWINDOW			;Caso tenha ocorrido, limpa a janela.
	;Qualquer comando que ocorrer depois da SPLASHWINDOW vai ocasionar a limpeza da tela.
	;Mesmo que não seja um comando válido.
...
; COPYRIGHT MESSAGE
		dt		CR,LF
		dt		"Copyright 2005, Ricardo de Azambuja"
