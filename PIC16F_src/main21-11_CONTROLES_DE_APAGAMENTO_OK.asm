...
;NÃO ESQUECER QUE TODAS ESSAS VARIÁVEIS SERÃO DE 8BITS
	...
	CBLOCK		0x20				;ENDEREÇO INICIAL DA MEMÓRIA DE USUÁRIO
				...
				MARGEM_SUPERIOR		;Numero de linhas apagadas na parte de cima da tela
				MARGEM_INFERIOR		;Numero de linhas apagadas na parte de baixo da tela
...
INT_TIMER0
	...
	bsf			STATUS,0			;Seta o Carry (se ele for 0, negativo)
	subwf		CONT_VERT,W
	btfsc		STATUS,0
	goto		DESENHA_TELA1
...
MAIN
	...
	movlw		B'01010101'		;Carrega a memória RAM com esse valor
	movwf		0x50			;para eu poder testar as rotinas de leitura/escrita de bit
	movlw		B'01010101'		;no pino definido por saida.'
	movwf		0x51	
	movlw		B'01010101'		
	movwf		0x52
	movlw		B'01010101'
...
;conforme eh feito abaixo (cada vez que for escrita uma linha)
	...
	goto		FIM_DA_IMAGEM				;algo na tela (reduzi um dos nops anteriores)
	nop
