...
;NÃO ESQUECER QUE TODAS ESSAS VARIÁVEIS SERÃO DE 8BITS
	...
	CBLOCK		0x70				;ENDEREÇO INICIAL DA MEMÓRIA DE USUÁRIO
				...
				CONTADORLED_OERR	;Contador usado para manter o led aceso por algum tempo (0x73)
				CONT_VERT			;Usada para contar o numero de linhas horizontais que foram desenhadas (0x74)
				FLAGS				;Usado para as flags do programa (0x75)
				MARGEM_SUPERIOR		;Numero de linhas apagadas na parte de cima da tela + 14 (0x76)
				MARGEM_INFERIOR		;Numero de linhas apagadas na parte de baixo da tela + 14 (0x77)
				CONTA_3LINHAS		;Conta as tres linhas do video para formar um pixel no TEXVID (0x78)
...
END_INIC_VIDEO	EQU		0x20			;Endereco inicial na RAM onde consta a imagem
END_FIM_VIDEO	EQU		0xEF			;Endereco final na RAM
...
;um tratamento por software (polling).
	...
	goto		SAI_INT				;Esta linha soh seria executada se tivesse sido feita alguma
									;configuracao errada no inicio do programa.
;
;
...
FIM_DESENHA_TELA1
	...
	movf		MARGEM_INFERIOR,W
	bcf			STATUS,0			;Seta o Carry (se ele for 0, negativo)
	subwf		CONT_VERT,W
	btfsc		STATUS,0
	bcf			TELA	

	;9+5=14 ciclos que devem ser retirados do NOPS .24
;	NOPS .10 ;10 ciclos cravados
	decfsz		CONTA_3LINHAS,F
...
;****************************************************************************
	...
	movlw		.3					;Carrega o contador de linhas 
	movwf		CONTA_3LINHAS		;usado para gerar os pixels (3linhas)
...
MAIN
	...
	;Tenho que cuidar porque nao posso mais usar o FSR em outro lugar
	movlw		END_INIC_VIDEO
	movwf		FSR
...
SEM_SINC_H
	...
	;Preciso de 8 ciclos de atraso a partir deste ponto ateh
	;o inicio da geracao da imagem 
...
;Sao tres linhas com seis pulsos de sincronizacao
	...
	movlw		.3					;Recarrega o contador de linhas
	movwf		CONTA_3LINHAS		;usado para criar os meus pixels
...
CARREGA_IMAGEM
	...
	;linha 2/5
	movlw		B'00010010'
	movwf		END_INIC_VIDEO + .6	
	movlw		B'01010101'
	movwf		END_INIC_VIDEO + .7
	movlw		B'00001101'		
	movwf		END_INIC_VIDEO + .8
	movlw		B'00000000'
	movwf		END_INIC_VIDEO + .9
	movlw		B'00000000'
	movwf		END_INIC_VIDEO + .10
	movlw		B'00000000'
	movwf		END_INIC_VIDEO + .11
	;linha 3/5
	movlw		B'00110010'
	movwf		END_INIC_VIDEO + .12
	movlw		B'01010010'
	movwf		END_INIC_VIDEO + .13
	movlw		B'00010100'		
	movwf		END_INIC_VIDEO + .14
	movlw		B'00000000'
	movwf		END_INIC_VIDEO + .15
	movlw		B'00000000'
	movwf		END_INIC_VIDEO + .16
	movlw		B'00000000'
	movwf		END_INIC_VIDEO + .17

	;linha 4/5
	movlw		B'00010010'
	movwf		END_INIC_VIDEO + .18
	movlw		B'01010101'
	movwf		END_INIC_VIDEO + .19
	movlw		B'00010101'		
	movwf		END_INIC_VIDEO + .20
	movlw		B'00000000'
	movwf		END_INIC_VIDEO + .21
	movlw		B'00000000'
	movwf		END_INIC_VIDEO + .22
	movlw		B'00000000'
	movwf		END_INIC_VIDEO + .23

	;linha 5/5
	movlw		B'01110010'
	movwf		END_INIC_VIDEO + .24
	movlw		B'00100101'
	movwf		END_INIC_VIDEO + .25
	movlw		B'00001101'		
	movwf		END_INIC_VIDEO + .26
	movlw		B'00000000'
	movwf		END_INIC_VIDEO + .27
	movlw		B'00000000'
	movwf		END_INIC_VIDEO + .28
	movlw		B'00000000'
	movwf		END_INIC_VIDEO + .29
