...
;NÃO ESQUECER QUE TODAS ESSAS VARIÁVEIS SERÃO DE 8BITS
	...
	CBLOCK		0x70				;ENDEREÇO INICIAL DA MEMÓRIA DE USUÁRIO
				...
				CONTA_3LINHAS_A		;Conta as tres linhas do video para formar um pixel no TEXVID (0x78)
				CONTA_3LINHAS_B		;Conta as tres linhas do video para formar um pixel no TEXVID (0x79)
...
END_INIC_VIDEO	EQU		0x30			;Endereco inicial na RAM onde consta a imagem
END_BASE_LINHA	EQU		0x20			;Usado junto com a macro SAIDABIT

LINHA_INICIO	EQU		.100			;Numero da linha na qual a imagem deve ser ligada
LINHA_FIM		EQU		.200			;Numero da linha na qual a imagem deve ser desligada

TAM_PXL			EQU		.4				;Altura do pixel (em numero de linhas)
