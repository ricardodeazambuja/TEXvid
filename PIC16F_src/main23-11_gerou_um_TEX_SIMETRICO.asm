...
LINHA_INICIO	EQU		.60				;Numero da linha na qual a imagem deve ser ligada
LINHA_FIM		EQU		.17				;Numero de linhas ligadas
...
;	NOPS .7
	...
	movlw		TAM_PXL-.2						;na primeira linha apos a MARGEM_SUPERIOR
	btfss		TELA
