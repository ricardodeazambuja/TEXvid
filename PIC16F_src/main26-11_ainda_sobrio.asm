...
ESCREVE_NA_LINHA
	...
	bcf			MEIOBYTE				;isso o CONT_BUFFER2 só é incrementado com a metade
	btfss		MEIOBYTE				;da freq que os caracteres do buffer são lidos.
	bsf			MEIOBYTE				;O EndereçoDaLetra também fica com metade da freq.
