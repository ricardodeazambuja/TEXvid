...
;NÃO ESQUECER QUE TODAS ESSAS VARIÁVEIS SERÃO DE 8BITS
	...
	CBLOCK		0x20				;ENDEREÇO INICIAL DA MEMÓRIA DE USUÁRIO
				...
				CONT_VERT			;Usada para contar o numero de linhas horizontais que foram desenhadas
				CONT_PRETO			;Conta as linhas apagadas no inicio do campo
				FLAGS				;Usado para as flags do programa
...
#DEFINE			RETRACO	FLAGS,2			;Sinaliza o nivel de preto para retraco vertical

#DEFINE			ODD		FLAGS,3			;Sinaliza se o campo eh par ou impar
										;ODD->1 impar
										;ODD->0 par
...
;****************************************************************************
	...
	movlw		.206		
	movwf		CONT_PRETO			;Numero de linhas que sao apagadas no 
									;inicio de cada campo (50linhas)
	...
	bsf			RETRACO				;O primeiro campo jah comeca com as
									;primeiras linhas apagadas
...
PAR
	bcf			ODD
	movlw		.0					;Normalmente eh com 14, mas agora quero
